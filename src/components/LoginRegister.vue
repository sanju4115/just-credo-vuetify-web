          ...
          <v-flex md4 sm12>
            <v-card dark class="transparent featureBox colorPrimaryText--text elevation-0">
              ...
              <div class="features1-content left">
                ...
                <p>Users can broswe all the details like classes and boards available, facilities and extracurricular activities
          ...
          <v-flex md4 sm12>
            <v-card dark class="transparent featureBox colorPrimaryText--text elevation-0">
              <div class="features1-content right">
                ...
                <h4>Bookmarking</h4>
                <p>You can see the upto date details, browse images, read blogs/reviews, get the contact details and you can bookmark
                  it so that you can compare them later. You can find bookmarked places in profile section of the app.</p>
              </div>
              <div class="features1-content right">
                <v-icon>receipt</v-icon>
                <h4>Read Reviews</h4>
                <p>Places can be brosed based on rating and reviews given by the end users. People can read the reviews.</p>
              </div>
            </v-card>
          </v-flex>
        </v-layout>
